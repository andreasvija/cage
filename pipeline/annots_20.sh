...
nextflow \
	...
	--txrev_pheno_meta_path ../../analysis/txrevise/scripts/processed/Homo_sapiens.GRCh38.96_CAGE-20/txrevise_CAGE-20_phenotype_metadata.tsv.gz \
	--skip_exon_norm \
	--skip_tx_norm \
...
../../nextflow/nextflow \
	run qtlmap/main.nf \
	-profile tartu_hpc \
	--studyFile ../sources_annots_20.tsv \
	--cis_window 200000 \
...
gunzip results/sumstats/txrevise_annots.permuted.txt.gz -c > ../../analysis/txrev_annots_20.permuted.txt
