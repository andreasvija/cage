...
NXF_VER=18.10.1 nextflow \
	...
	--skip_stringtie \
	--run_txrevise \
	--txrevise_gffs '../../analysis/txrevise/scripts/processed/Homo_sapiens.GRCh38.96_CAGE-50/txrevise_*.gff3' \
	-resume \
...
nextflow \
	...
	--txrev_pheno_meta_path ../../analysis/txrevise/scripts/processed/Homo_sapiens.GRCh38.96_CAGE-50/txrevise_CAGE-50_phenotype_metadata.tsv.gz \
	--skip_exon_norm \
	--skip_tx_norm \
...
../../nextflow/nextflow \
	run qtlmap/main.nf \
	-profile tartu_hpc \
	--studyFile ../sources_annots_50.tsv \
	--cis_window 200000 \
...
gunzip results/sumstats/txrevise_annots.permuted.txt.gz -c > ../../analysis/txrev_annots_50.permuted.txt
