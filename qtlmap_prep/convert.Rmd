...
lower_threshold = 0
commonGenes = (filter(geneCounts, geneCount > lower_threshold))$gene # 946 / 20 193 are zeroes (4.7%)
...
upstream1 = GenomicFeatures::makeTxDbFromGFF("../analysis/txrevise.grp_1.upstream.gff3")
upstream2 = GenomicFeatures::makeTxDbFromGFF("../analysis/txrevise.grp_2.upstream.gff3")
...
saveRDS(common_genes, "../analysis/common_genes.rds")
```
