...
lower_threshold = 0
commonGenes = (filter(geneCounts, geneCount > lower_threshold))$gene # 946 / 20 201 are zeroes (4.7%)
data = filter(data, gene %in% commonGenes) # 245 476 / 14 424 102 samples removed (1.7%)
