...
assigned_total / total #  34.0% 46.0%
unmapped_total / total #   4.8% 0%
nofeatures_total / total #61.2% 54.0%
```
...
length(unique(data$promoter))
dim(data)
data = filter(data, gene %in% commonGenes) 
length(unique(data$gene))
length(unique(data$promoter))
dim(data)
# 946 / 20 193 are zeroes (4.7%) (1594 promotors)
# 1647 / 20 193 are zeroes (8.2%) (1594 promotors)
# 245 476 / 14 407 316 samples removed (1.7%)
# 546 854 / 14 407 316 samples removed (3.8%)
