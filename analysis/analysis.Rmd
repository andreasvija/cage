...
(dim(ann_tops)[1] - dim(tx25_tops)[1]) / dim(tx25_tops)[1] # 29.1%

length(intersect(bwa_tops$gene, tx25_tops$gene)) # 280
length(intersect(bwa_tops$gene, ann_tops$gene)) # 353
length(intersect(tx25_tops$gene, ann_tops$gene)) # 730
