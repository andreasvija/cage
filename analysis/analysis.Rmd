...
txrevise_results_ = fill_genes(txrevise_results)
txrevise_results_common_ = fill_genes(txrevise_results_common, common=TRUE)
annots_results_ = fill_genes(annots_results)
annots_results_common_ = fill_genes(annots_results_common, common=TRUE)
```
